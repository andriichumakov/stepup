...
- **Memory Dashboard**: Dedicated activity for managing and viewing memories
...
- **Settings Management**: Comprehensive settings with specialized managers for data, UI, images, and account management
...
- **Memory Notifications**: Alerts for newly added memories
...
The app follows SOLID principles with a service-oriented architecture and dependency injection patterns:
...
- **MemoryDashboardActivity**: Advanced memory management interface
- **AddMemoryActivity**: Create new memory entries
- **SettingsActivity**: App configuration with specialized managers
- **StepsOverviewActivity**: Statistics and progress charts

### Services
- **StepCounterService**: Foreground service for continuous step counting with health service type
- **ProfileService**: User profile management with Supabase integration

### Manager System
The app uses a comprehensive manager system for separation of concerns:

#### Core Managers
- **StepTrackingManager**: Real-time step counting and UI updates
...
#### UI & Widget Managers
- **WeatherWidgetManager**: Weather display and updates
- **MemoryWidgetManager**: Memory widget functionality
- **QuoteWidgetManager**: Inspirational quotes display
- **ActionBarGreetingManager**: Dynamic greeting updates
- **ActionBarProfileManager**: Profile picture management in action bar
- **ActionBarLocationManager**: Location display in action bar

#### Settings Managers (SOLID Architecture)
- **SettingsDataManager**: Data persistence and synchronization
- **SettingsUIManager**: User interface management
- **SettingsImageManager**: Profile image handling
- **SettingsAccountManager**: Account management operations
- **SettingsServiceManager**: Service restart and state management

#### Preferences Managers
- **StepPreferencesManager**: Step-related preferences
- **UserProfilePreferencesManager**: User profile data
- **InterestPreferencesManager**: Interest selections
- **SyncPreferencesManager**: Synchronization state
- **StreakPreferencesManager**: Achievement streaks
- **MemoryPreferencesManager**: Memory-related preferences

#### Specialized Managers
- **BackgroundSyncManager**: Offline data synchronization
- **HomeNavigationManager**: Home screen navigation
- **ImagePickerManager**: Image selection and processing
...
- **Local Database**: Room database for places and memories
...
5. **Settings Not Saving**: Check internet connection for cloud sync or verify local storage permissions
...
- Monitor background sync through BackgroundSyncManager logs
